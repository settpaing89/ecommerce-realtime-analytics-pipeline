...
def generate_products(num_products):
    ...
    for i in range(num_products):
        ...
        product = {
            ...
            'current_price': round(base_price * random.uniform(0.8, 1.2), 2),  # Price variation
            'cost': round(base_price * random.uniform(0.4, 0.7), 2),  # Cost is 40-70% of base price
...
def generate_orders(num_orders, customers_df, products_df):
    ...
    for i in range(num_orders):
        ...
        # Get product price
        product_price = products_df[products_df['product_id'] == product_id]['current_price'].values[0]
        ...
        shipping = round(random.uniform(0, 15.99), 2) if subtotal < 50 else 0  # Free shipping over $50
        ...
        if days_ago < 1:
            ...
            status = random.choice(['delivered', 'delivered', 'delivered', 'cancelled'])  # Mostly delivered
        ...
        order = {
            ...
            'billing_address': fake.address() if random.random() > 0.7 else fake.address(),  # 30% different
...
def generate_events(num_events, customers_df, products_df):
    ...
    for i in range(num_events):
        ...
        event = {
            ...
            'product_id': random.choice(active_products) if random.random() > 0.3 else None,  # 70% product-related
...
def main():
    ...
    print(f"\n✅ SUCCESS!")
    print(f"Generated 4 datasets with {NUM_CUSTOMERS + NUM_PRODUCTS + NUM_ORDERS + NUM_EVENTS:,} total records")
